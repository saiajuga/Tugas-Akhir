...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-default">
      ...
      <form action="<?php echo base_url('dashboard/simpan_surattugas'); ?>" method="post" enctype="multipart/form-data">    
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="no_surattugas" id="no_surattugas" placeholder="No Surat Tugas" class="form-control" required>
              </div>
            </div>
          ...
          <table class="table table-bordered table-hover" id="laporan">
            ...
            <tbody>
              <?php
                $no=0;
                if($kd == '1'){
                  $data = $this->db->query("SELECT tbl_surattugas.id_surattugas,tbl_spk.pekerjaan,tbl_surattugas.no_surattugas,tbl_surattugas.pengawas,tbl_surattugas.dokumen 
                  FROM tbl_spk,tbl_surattugas 
                  WHERE tbl_spk.id_spk = tbl_surattugas.id_spk
                  AND tbl_spk.nilai_kontrak < '100000000'
                  ORDER BY tbl_surattugas.id_surattugas DESC");
                }elseif($kd=='2'){
                  $data = $this->db->query("SELECT tbl_surattugas.id_surattugas,tbl_spk.pekerjaan,tbl_surattugas.no_surattugas,tbl_surattugas.pengawas,tbl_surattugas.dokumen 
                  FROM tbl_spk,tbl_surattugas 
                  WHERE tbl_spk.id_spk = tbl_surattugas.id_spk
                ...
                foreach($data->result_array() as $tampil):
                  $no++;
                  $id_surattugas = $tampil['id_surattugas'];
                  $pekerjaan = $tampil['pekerjaan'];
                  $no_surattugas = $tampil['no_surattugas'];
              ...
              ?>
                <tr>
                  ...
                  <td class="text-left"><?php echo $no_surattugas; ?></td>
                  <td class="text-center"><?php echo $pengawas; ?></td>
                  <td class="text-center">
                    <a href="#" data-toggle="modal" data-target="#lihat<?php echo $id_surattugas; ?>">
                      <small class="label pull-center bg-blue"><i class="fa fa-eye"></i> Lihat</small>
                    </a>
                    <div class="modal fade in" id="lihat<?php echo $id_surattugas; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                            <h4 class="modal-title">Dokumen <?php echo $no_surattugas; ?></h4>
                          </div>
                  ...
                  <td class="text-center">
                    <a href="<?php echo base_url('dashboard/hapus_surattugas?id_surattugas='.$id_surattugas.'&kd='.$kd.'&mn='.$mn); ?>">
