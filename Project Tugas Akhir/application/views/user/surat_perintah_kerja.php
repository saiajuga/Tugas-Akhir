            ...
            <div class="form-horizontal table-responsive">
                <table class="table table-bordered table-hover" id="laporan">
                    ...
                    <tbody>
                        ...
                        // Query data
                        if($kd == '1'){
                            $data = $this->db->query("SELECT * FROM tbl_spk WHERE nilai_kontrak < '100000000' ORDER BY id_spk DESC");
                        } elseif($kd=='2'){
                            $data = $this->db->query("SELECT * FROM tbl_spk WHERE nilai_kontrak BETWEEN '100000000' AND '300000000' ORDER BY id_spk DESC");
                        } elseif($kd=='3'){
                            $data = $this->db->query("SELECT * FROM tbl_spk WHERE nilai_kontrak > '300000000' ORDER BY id_spk DESC");
                        }
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url('dashboard/hapus_spk?id_spk='.$id_spk.'&kd='.$kd.'&mn='.$mn); ?>">
