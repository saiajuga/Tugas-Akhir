...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-default">
      ...
      <form action="<?php echo base_url('dashboard/simpan_beritaacara'); ?>" method="post" enctype="multipart/form-data">   
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Berita</label>
                <input type="text" name="berita" id="berita" placeholder="Berita" class="form-control" required>
              </div>
            </div>
            ...
            <div class="col-md-6">    
              ...
              <div class="form-group">
                <label>No Berita</label>
                <input type="text" name="no_berita" id="no_berita" placeholder="No Berita" class="form-control" required>
              </div>
          ...
          <table class="table table-bordered table-hover" id="laporan">
            ...
            <tbody>
              <?php
                $no=0;
                if($kd == '1'){
                  $data = $this->db->query("SELECT tbl_beritaacara.id_beritaacara, tbl_beritaacara.berita, tbl_beritaacara.no_berita, tbl_beritaacara.dokumen
                  FROM tbl_beritaacara,tbl_spk 
                  WHERE tbl_beritaacara.id_spk = tbl_spk.id_spk
                  AND tbl_spk.nilai_kontrak < '100000000'
                  ORDER BY tbl_beritaacara.id_beritaacara DESC");
                }elseif($kd=='2'){
                  $data = $this->db->query("SELECT tbl_beritaacara.id_beritaacara, tbl_beritaacara.berita, tbl_beritaacara.no_berita, tbl_beritaacara.dokumen
                  FROM tbl_beritaacara,tbl_spk 
                  WHERE tbl_beritaacara.id_spk = tbl_spk.id_spk
                ...
                foreach($data->result_array() as $tampil):
                  $no++;
                  $id_beritaacara = $tampil['id_beritaacara'];
                  $berita = $tampil['berita'];
                  $no_berita = $tampil['no_berita'];
                  $dokumen = $tampil['dokumen'];
              ?>
                <tr>
                  <td class="text-center"><?php echo $no; ?></td>
                  <td class="text-left"><?php echo $pekerjaan; ?></td>
                  <td class="text-left"><?php echo $berita; ?></td>
                  <td class="text-left"><?php echo $no_berita; ?></td>
                  <td class="text-center">
                    <a href="#" data-toggle="modal" data-target="#lihat<?php echo $id_beritaacara; ?>">
                      <small class="label pull-center bg-blue"><i class="fa fa-eye"></i> Lihat</small>
                    </a>
                    <div class="modal fade in" id="lihat<?php echo $id_beritaacara; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                            <h4 class="modal-title">Dokumen <?php echo $no_berita; ?></h4>
                          </div>
                  ...
                  <td class="text-center">
                    <a href="<?php echo base_url('dashboard/hapus_beritaacara?id_beritaacara='.$id_beritaacara.'&kd='.$kd.'&mn='.$mn); ?>">
