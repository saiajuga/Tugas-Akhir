...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-default">
      ...
      <form action="<?php echo base_url('dashboard/simpan_laporankerja'); ?>" method="post" enctype="multipart/form-data">
          ...
          <table class="table table-bordered table-hover" id="laporan">
            <thead>
              <tr class="bg-primary">
                ...
                <th class="text-center">Jangka Kontrak</th>
            ...
            <tbody>
              <?php
                $no=0;
                if($kd == '1'){
                  $data = $this->db->query("SELECT tbl_spk.pekerjaan, tbl_spk.lokasi, tbl_spk.nomor_kontrak, tbl_spk.jangka_kontrak, tbl_spk.nilai_kontrak, tbl_laporankerja.dokumen, tbl_laporankerja.id_laporankerja 
                  FROM tbl_spk,tbl_laporankerja 
                  WHERE tbl_spk.id_spk = tbl_laporankerja.id_spk
                  AND tbl_spk.nilai_kontrak < '100000000'
                  ORDER BY tbl_laporankerja.id_laporankerja DESC");
                }elseif($kd=='2'){
                  $data = $this->db->query("SELECT tbl_spk.pekerjaan, tbl_spk.lokasi, tbl_spk.nomor_kontrak, tbl_spk.jangka_kontrak, tbl_spk.nilai_kontrak, tbl_laporankerja.dokumen, tbl_laporankerja.id_laporankerja
                  FROM tbl_spk,tbl_laporankerja 
                  WHERE tbl_spk.id_spk = tbl_laporankerja.id_spk
                ...
                foreach($data->result_array() as $tampil):
                  $no++;
                  $id_laporankerja = $tampil['id_laporankerja'];
                  $pekerjaan = $tampil['pekerjaan'];
              ...
              ?>
                <tr>
                  ...
                  <td class="text-left"><?php echo $nomor_kontrak; ?></td>
                  <td class="text-left"><?php echo $jangka_kontrak; ?></td>
                  <td class="text-left"><?php echo format_rupiah($nilai_kontrak); ?></td>
                  <td class="text-center">
                    <a href="#" data-toggle="modal" data-target="#lihat<?php echo $id_laporankerja; ?>">
                      <small class="label pull-center bg-blue"><i class="fa fa-eye"></i> Lihat</small>
                    </a>
                    <div class="modal fade in" id="lihat<?php echo $id_laporankerja; ?>">
                  ...
                  <td class="text-center">
                    <a href="<?php echo base_url('dashboard/hapus_laporankerja?id_laporankerja='.$id_laporankerja.'&kd='.$kd.'&mn='.$mn); ?>">
