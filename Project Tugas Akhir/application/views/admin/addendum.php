...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-default">
      ...
      <form action="<?php echo base_url('dashboard/simpan_addendum'); ?>" method="post" enctype="multipart/form-data">   
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>No Addendum</label>
                <input type="text" name="no_addendum" id="no_addendum" placeholder="No Addendum" class="form-control" required>
              </div>
            </div>
          ...
          <table class="table table-bordered table-hover" id="laporan">
            <thead>
              <tr class="bg-primary">
                ...
                <th class="text-center">Nomor Addendum</th>
            ...
            <tbody>
              <?php
                $no=0;
                if($kd == '1'){
                  $data = $this->db->query("SELECT tbl_addendum.id_addendum,tbl_spk.pekerjaan,tbl_addendum.no_addendum,tbl_addendum.dokumen 
                  FROM tbl_spk,tbl_addendum 
                  WHERE tbl_spk.id_spk = tbl_addendum.id_spk
                  AND tbl_spk.nilai_kontrak < '100000000'
                  ORDER BY tbl_addendum.id_addendum DESC");
                }elseif($kd=='2'){
                  $data = $this->db->query("SELECT tbl_addendum.id_addendum,tbl_spk.pekerjaan,tbl_addendum.no_addendum,tbl_addendum.dokumen 
                  FROM tbl_spk,tbl_addendum 
                  WHERE tbl_spk.id_spk = tbl_addendum.id_spk
                ...
                foreach($data->result_array() as $tampil):
                  $no++;
                  $id_addendum = $tampil['id_addendum'];
                  $pekerjaan = $tampil['pekerjaan'];
                  $no_addendum = $tampil['no_addendum'];
                  $dokumen = $tampil['dokumen'];
              ?>
                <tr>
                  <td class="text-center"><?php echo $no; ?></td>
                  <td class="text-left"><?php echo $pekerjaan; ?></td>
                  <td class="text-left"><?php echo $no_addendum; ?></td>
                  <td class="text-center">
                    <a href="#" data-toggle="modal" data-target="#lihat<?php echo $id_addendum; ?>">
                      <small class="label pull-center bg-blue"><i class="fa fa-eye"></i> Lihat</small>
                    </a>
                    <div class="modal fade in" id="lihat<?php echo $id_addendum; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                            <h4 class="modal-title">Dokumen: <?php echo $no_addendum; ?></h4>
                          </div>
                  ...
                  <td class="text-center">
                    <a href="<?php echo base_url('dashboard/hapus_addendum?id_addendum='.$id_addendum.'&kd='.$kd.'&mn='.$mn); ?>">
