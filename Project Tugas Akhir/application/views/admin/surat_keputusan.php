...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-default">
      ...
      <form action="<?php echo base_url('dashboard/simpan_suratkeputusan'); ?>" method="post" enctype="multipart/form-data">   
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="no_suratkeputusan" id="no_suratkeputusan" placeholder="No Surat Keputusan" class="form-control" required>
              </div>
            </div>
            ...
            <div class="col-md-6">    
              ...
              <div class="form-group">
                ...
                <input type="text" name="pengawas" id="pengawas" placeholder="Pengawas" class="form-control" required>
              </div>
              
              <div class="form-group">
                <label>Dokumen (Harus .Pdf Ukuran Max 1 MB)</label>
          ...
          <table class="table table-bordered table-hover" id="laporan">
            <thead>
              <tr class="bg-primary">
                ...
                <th class="text-center">No Surat Keputusan</th>
            ...
            <tbody>
              <?php
                $no=0;
                if($kd == '1'){
                  $data = $this->db->query("SELECT tbl_suratkeputusan.id_suratkeputusan, tbl_suratkeputusan.no_suratkeputusan, tbl_suratkeputusan.pengawas, tbl_suratkeputusan.dokumen
                  FROM tbl_suratkeputusan,tbl_spk 
                  WHERE tbl_spk.id_spk = tbl_suratkeputusan.id_spk
                  AND tbl_spk.nilai_kontrak < '100000000'
                  ORDER BY tbl_suratkeputusan.id_suratkeputusan DESC");
                }elseif($kd=='2'){
                  $data = $this->db->query("SELECT tbl_suratkeputusan.id_suratkeputusan, tbl_suratkeputusan.no_suratkeputusan, tbl_suratkeputusan.pengawas, tbl_suratkeputusan.dokumen
                  FROM tbl_suratkeputusan,tbl_spk 
                  WHERE tbl_spk.id_spk = tbl_suratkeputusan.id_spk
                ...
                foreach($data->result_array() as $tampil):
                  $no++;
                  $id_suratkeputusan = $tampil['id_suratkeputusan'];
                  $no_suratkeputusan = $tampil['no_suratkeputusan'];
                  $pengawas = $tampil['pengawas'];
                  $dokumen = $tampil['dokumen'];
              ?>
                <tr>
                  <td class="text-center"><?php echo $no; ?></td>
                  <td class="text-left"><?php echo $pekerjaan; ?></td>
                  <td class="text-left"><?php echo $no_suratkeputusan; ?></td>
                  <td class="text-left"><?php echo $pengawas; ?></td>
                  <td class="text-center">
                    <a href="#" data-toggle="modal" data-target="#lihat<?php echo $id_suratkeputusan; ?>">
                      <small class="label pull-center bg-blue"><i class="fa fa-eye"></i> Lihat</small>
                    </a>
                    <div class="modal fade in" id="lihat<?php echo $id_suratkeputusan; ?>">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span></button>
                            <h4 class="modal-title">Dokumen: <?php echo $no_suratkeputusan; ?></h4>
                          </div>
                  ...
                  <td class="text-center">
                    <a href="<?php echo base_url('dashboard/hapus_suratkeputusan?id_suratkeputusan='.$id_suratkeputusan.'&kd='.$kd.'&mn='.$mn); ?>">
