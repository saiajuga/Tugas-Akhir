...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-default">
      ...
      <form action="<?php echo base_url('dashboard/simpan_pengguna'); ?>" method="post">      
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" placeholder="Nama Pengguna" class="form-control" required>
              </div>
